// ✅ Full Working Embed System with Player Switch Support
...
document.getElementById("player-selector").addEventListener("change", (e) => {
  ...
  if (imdb && title) {
    setAll(imdb, title.replace(/_/g, " "), season, episode, type);
  }
});
...
// Main function to set everything based on input
...
// Set video in iframe and update UI
function setVideo(e) {
...
// Optional: smooth scroll to top function
function scrollToTop() {
  window.scrollTo({ top: 0, behavior: "smooth" });
}

// ✅ You must implement these two async functions somewhere in your code:
async function fetchTmdbIdFromImdb(imdbId) {
  // Replace with your own TMDB API call

        ...
        (resultsContainer.innerHTML = ""),
          t.forEach((e) => {
            if (e.i && ("movie" === e.qid || "tvSeries" === e.qid)) {
              ...
              let i = "";
              "movie" === e.qid && e.i
                ? (i = `<a onClick="setUrl(this); setnow(this);return setVideo(this);" url="imdb=${
                    e.id
...
const PLAYER_CONFIG = {
  ...
  embedMovieUrl: (e) => `https://vidsrs.xyz/embed/movie/${e}`,
  embedTvUrl: (e, t, i) => `https://vidsrs.xyz/embed/tv/${e}/${t}/${i}`,
};
